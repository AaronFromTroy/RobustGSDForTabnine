...
- 🐛 Report bugs via [GitHub Issues](https://github.com/yourusername/gsd-for-tabnine/issues)
...
```
🚀 GSD for Tabnine - Basic Usage Demo

📖 Example 1: Reading project state
No STATE.md found (expected for new projects)

📝 Example 2: Rendering PROJECT.md template
Template rendered successfully
Output length: 450 characters

📋 Example 3: Loading new-project guideline
