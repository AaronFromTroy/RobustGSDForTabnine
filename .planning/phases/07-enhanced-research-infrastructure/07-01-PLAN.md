...
# Check browser cleanup (try-finally) - separate greps to avoid spacing fragility
grep "chromium\.launch" gsd/scripts/scraper.js
grep "finally" gsd/scripts/scraper.js
