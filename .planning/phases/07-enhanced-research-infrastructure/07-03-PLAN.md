...
# Check scrapeContent usage
grep "scrapeContent(" gsd/scripts/researcher.js
...
# Check buildDocumentationUrls helper
grep "buildDocumentationUrls" gsd/scripts/researcher.js
```

Imports should exist, scraping integrated, deduplication added.
  </verify>
  <done>
researcher.js updated with real scraping imports. performResearch() uses scrapeContent() instead of generateMockSearchResults(). buildDocumentationUrls() helper added for MVP documentation URL building. extractFindings() calls deduplicateFindings(). assignConfidenceLevel integrated from source-validator.js. Mock function deprecated with comment.
  </done>
</task>
