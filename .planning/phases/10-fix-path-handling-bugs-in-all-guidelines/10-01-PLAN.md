...
4. **Git validation:**
All three guideline files should pass markdown linting and have consistent formatting.
</verification>

<success_criteria>
1. All `mkdir` commands in plan-phase.md use `-p` flag
2. All bash paths containing variables are wrapped in double quotes across all three guidelines
...
7. Git commits show only the three guideline files modified
</success_criteria>
